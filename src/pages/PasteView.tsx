    ...
    <div className="flex h-[calc(100vh-3rem)]">
      <div className="flex-1 overflow-y-auto">
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                {paste.pinned && <Pin className="h-4 w-4 text-white/40" />}
              </div>
            ...
            {isOwner && (
              <Dialog>
                ...
                <DialogContent className="bg-[hsl(0,0%,4%)] border-white/10 backdrop-blur-xl">
                  <DialogHeader>
          ...
          <pre className="whitespace-pre-wrap text-sm leading-relaxed bg-white/[0.02] rounded-xl p-6 border border-white/[0.06] font-mono backdrop-blur-sm">
            {sanitize(paste.content)}
          </pre>
        </div>
      </div>

      <div className="w-80 shrink-0 border-l border-white/[0.06] bg-white/[0.02] flex flex-col backdrop-blur-sm">
        <div className="p-3 border-b border-white/[0.06] flex items-center gap-2 text-sm font-semibold text-muted-foreground">
        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-3">
          ...
          {comments.map((comment) => (
            <div key={comment.id} className="bg-white/[0.03] rounded-lg p-3 border border-white/[0.04]">
          ...
          <div className="p-3 border-t border-white/[0.06]">
            <div className="flex gap-2">
              <Textarea
                ...
                className="min-h-[60px] bg-white/[0.04] border-white/[0.08] text-xs resize-none"
                onKeyDown={(e) => {
